...
(`Nombre`, `Descripción`, `Tipo`, `Plataforma`, `Desarrolladora`, `Publicadora`, `Precio`, `Lanzamiento`, `Portada`)
VALUES
...
('God of War', 'En el juego que inició todo (no confundir con el del mismo nombre de PS4), Kratos desea redimirse y olvidar todo lo que hizo bajo las órdenes de Ares, el dios de la guerra, por lo que los dioses le comandan enfrentarse a él bajo esa promesa', 'Hack and slash', 'PlayStation 2', 'Santa Monica Studio', 'Sony', 15.00, '2005-03-22', 'gow.webp'),
('The Legend of Zelda', 'Este juego empieza la misión común de la saga de enfrentarse a Ganon para salvar Hyrule y rescatar a la princesa Zelda, obteniendo las piezas de la Trifuerza por el camino', 'Aventura', 'Famicon', 'Nintendo', 'Nintendo', 10.00, '1986-02-21', 'tloz.jpg'),
('Donkey Kong', 'Jumpman (Mario) tiene que rescatar a una dama (Pauline) del gorila Donkey Kong (aunque juegos futuros implican que en realidad se trata de su abuelo, Cranky Kong), teniendo que escalar un edificio y evitar los barriles que le lanzan', 'Plataformas', 'Arcade', 'Nintendo', 'Nintendo', 10.00, '1981-07-09', 'dk.jpg'),
('Grand Theft Auto', 'En este juego que empezó una de las sagas más vendidas de la historia, el protagonista tiene que hacer todo lo que pueda para obtener dinero, trabajando para organizaciones criminales y haciendo varias misiones con ese objetivo', 'Aventura', 'PC', 'DMA Design', 'BMG Interactive', 12.00, '1997-11-28', 'gta.webp'),
...
('The Witcher', 'Este juego es una secuela de los libros, Geralt se olvida de quien es y todo lo que hizo y sus amigos intentan curarle de esa condición', 'RPG', 'PC', 'CD Projekt', 'Atari', 8.00, '2007-10-26', 'tw.jpg'),
('Pocket Monsters Red and Blue', 'Aquí se inició la saga de juegos de Pokémon, en estos juegos (la saga siempre saca dos juegos a la vez) vives las aventuras de un niño deseando convertirse en maestro pokémon', 'RPG', 'Game Boy', 'Game Freak', 'Nintendo', 5.00, '1996-02-27', 'pmr.webp'),
('Sonic the Hedgehog', 'En esta primera aventura de Sonic, este tiene que detener los malvados planes del doctor Eggman y evitar que obtenga las Chaos Emeralds, salvando los animales que el doctor loco encerró para convertir en máquinas por el camino', 'Plataformas', 'Genesis', 'Sega', 'Sega', 9.00, '1997-06-21', 'sth.jpg');";
